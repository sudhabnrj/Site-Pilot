...
export default function SeoPage() {
    ...
    ? [
        {
          ...
          iconBgClass: currentReport.seoScore >= 80 ? "bg-emerald-50 border-emerald-100/50" : currentReport.seoScore >= 70 ? "bg-amber-50 border-amber-100/50" : "bg-red-50 border-red-100/50",
          iconColorClass: currentReport.seoScore >= 80 ? "text-emerald-600" : currentReport.seoScore >= 70 ? "text-amber-600" : "text-red-600",
          progressBarColor: currentReport.seoScore >= 80 ? "bg-emerald-500" : currentReport.seoScore >= 70 ? "bg-amber-500" : "bg-red-500",
        },
        {
          id: "tech-seo",
          icon: Settings,
          ...
          iconBgClass: (currentReport.seoScore - 5) >= 80 ? "bg-emerald-50 border-emerald-100/50" : (currentReport.seoScore - 5) >= 70 ? "bg-amber-50 border-amber-100/50" : "bg-red-50 border-red-100/50",
          iconColorClass: (currentReport.seoScore - 5) >= 80 ? "text-emerald-600" : (currentReport.seoScore - 5) >= 70 ? "text-amber-600" : "text-red-600",
          progressBarColor: (currentReport.seoScore - 5) >= 80 ? "bg-emerald-500" : (currentReport.seoScore - 5) >= 70 ? "bg-amber-500" : "bg-red-500",
        },
        {
          id: "backlinks",
          icon: LinkIcon,
          ...
          iconBgClass: (currentReport.seoScore + 4) >= 80 ? "bg-emerald-50 border-emerald-100/50" : (currentReport.seoScore + 4) >= 70 ? "bg-amber-50 border-amber-100/50" : "bg-red-50 border-red-100/50",
          iconColorClass: (currentReport.seoScore + 4) >= 80 ? "text-emerald-600" : (currentReport.seoScore + 4) >= 70 ? "text-amber-600" : "text-red-600",
          progressBarColor: (currentReport.seoScore + 4) >= 80 ? "bg-emerald-500" : (currentReport.seoScore + 4) >= 70 ? "bg-amber-500" : "bg-red-500",
        },
      ]
    : DEFAULT_BREAKDOWNS;
  ...
  return (
    <PlanGate requiredPlan="pro" featureName="SEO Audit & Technical Optimization">
