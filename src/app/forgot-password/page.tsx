        ...
        {!isSubmitted ? (
          <>
            <div className="text-center">
              <h1 className="text-2xl font-bold text-slate-800 mb-1 tracking-tight">Reset Password</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-[11px] font-medium tracking-wider text-slate-600 ml-1">
                  Email Address
                </label>
              ...
              >
                {isLoading ? (
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <span className="leading-[1px]">Send Reset Link</span>
