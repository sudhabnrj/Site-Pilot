...
import { Sparkles, Image, Code, CheckCircle, XCircle } from "lucide-react";
...
const MOCK_ISSUES = [
  {
    ...
    description: "Interactive elements (buttons, links) are less than 48px apart. This leads to accidental clicks.",
    fix: "Add 12px padding to navigation links",
  },
  {
    id: "iss-2",
    num: 2,
    ...
    description: "Horizontal scrolling detected at 375px. Usually caused by fixed-width containers or large images.",
    fix: "Use max-width: 100% on .hero-image",
  },
  {
    id: "iss-3",
    num: 3,
    ...
    description: "Font sizes below 12px were found in the footer area. Standard minimum is 14px-16px.",
    fix: "Increase footer font-size to 0.875rem",
  },
];
...
const OPTIMIZATIONS = [
  {
    ...
    description: "Inject viewport meta tag to resolve scaling issues.",
  },
  {
    id: "opt-2",
    icon: Image,
    title: "Responsive Images",
    description: "Generate 3 sizes for all hero assets automatically.",
  },
  {
    id: "opt-3",
    icon: Code,
    title: "CSS Refactor",
    description: "Replace fixed 'px' with 'rem' in layout containers.",
  },
];
...
export default function MobilePage() {
  ...
  const handleApplyOptimization = (title: string) => {
    alert(`Successfully applied recommended optimization: ${title}`);
  };
      ...
      <section className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2 select-none">
            ...
            <span className="text-slate-400 text-xs font-semibold">Last checked: 2 mins ago</span>
          </div>
          <h2 className="text-3xl font-black tracking-tight text-slate-900">
            Mobile Responsiveness
          </h2>
          <p className="text-slate-500 text-sm font-semibold max-w-2xl leading-relaxed">
            Analyze how your website performs across multiple device viewports. We've detected 3 critical usability issues that impact your SEO ranking.
          </p>
        </div>
          ...
          <GlassCard className="rounded-[24px] p-6 border-slate-200/80 shadow-sm bg-white/70 h-full flex flex-col justify-between">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start justify-items-center">
              ...
              <div className="space-y-4 w-full max-w-[320px]">
                ...
                <div className="aspect-video bg-slate-100 border border-slate-200 rounded-xl overflow-hidden relative group shadow-sm select-none">
                  <img
                    ...
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCXMJ_jW0n3DWMXE2ACDSNxURvlIMWPaTPWvjoN0bNgQPBnOkaCBBOzNiGuM0cJLk_07xQDUhuEHQUc36JJRg5JWXX4U8S4V6FaiLgzz7G4l3VQZAUt9IUVScD-8T6sYNzbXfOyLSgEfP4j8QVjzwCKuP7Nh1vMucMBGE82ysfxEZ13JehyoEQhuhuRUgGO9fY3WRhsFEoowFFFgcIlok_0h4AA-2j66UpIgTypwWeg9TXYBVCMavumFg"
                    alt="Desktop Mockup reference"
                  />
              ...
              <div className="space-y-4 w-full flex flex-col items-center">
                ...
                />
                <div className="flex justify-between w-[280px] text-[10px] font-bold text-slate-400 px-2 select-none mt-1">
                  <span className="flex items-center gap-1 text-red-500">
                    <XCircle className="h-3.5 w-3.5" /> 3 Layout Shifts
                  </span>
                  <span className="text-red-500">74% Score</span>
                </div>
              </div>
            </div>
          </GlassCard>
